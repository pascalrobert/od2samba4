...
for user in users_all:
	if user["uid"][0] != "root" and user["uid"][0] != "diradmin" and user["uid"][0] != "_ldap_replicator" and not user["uid"][0].startswith("vpn_") and user["uid"][0] != "_krb_anonymous" and user["uid"][0] != "_krb_changepw" and user["uid"][0] != "_krb_kadmin" and user["uid"][0] != "_krb_kerberos" and user["uid"][0] != "_krb_krbtgt" and user["uid"][0] != "_krb_krbtgt":
